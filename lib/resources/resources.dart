...
class AppColors {
  ...
  static const colorPrimary = Color(0xFFF3C76F);
  static const colorSecondary = Color(0xFFFFB88C);
  static const colorBrand = Color(0xFFF3C76F);
  ...
  static const bgAccent = Color(0xFF2C2C2C);
